                            ...
                            <div class="box-body">
                                <div class="row">
                                    <fieldset class="col-md-8 col-md-offset-2">
                                        ...
                                        <div align="center">
                                            <button id="submit" type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" onclick="myFunction"><span class="glyphicon glyphicon-save"></span>สมัครสมาชิก</button>
