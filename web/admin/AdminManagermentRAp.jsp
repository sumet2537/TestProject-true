                                ...
                                <div class="col-xs-12">
                                    <div class="box">
                                        <div class="box-header">
                                            <h3 class="box-title"> สินเชื่อรออนุมัติ</h3>
                                        </div>
                                        <!--.box-header-->
                                        <div class="box-body">
                                            <div >
                                                        ...
                                                        <table id="example1" class="table table-striped table-bordered">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a   class="btn btn-danger" data-toggle="modal" data-target="#myModal"><span class="fa fa-close"></span></a></td>
...
//        alert(คุณต้องการลบขอ้มูลใช่หรือไม่);
        ...
        function callActionGotoDetle(loanreq_id) {
            document.formshowdaterequestloan.loanreq_id.value = loanreq_id;
            document.formshowdaterequestloan.todo.value = 'DetleRAp';
            document.formshowdaterequestloan.submit();
